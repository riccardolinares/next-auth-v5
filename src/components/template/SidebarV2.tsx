...
const navigation = [
  { name: "Creators", href: "/creators", icon: HeartIcon },
...
const secondarynavigation = [
  ...
  },
  {
    ...
    href: "https://docs.google.com/forms/d/e/1FAIpQLScdvNbiCLOepjpCQuk-SJ0z5g9gWjNfpPUUyNTnaYqHci5p_Q/viewform",
    target: "_blank",
    icon: CheckBadgeIcon,
  },
];
                          ...
                          <ul role="list" className="-mx-2 mt-2 space-y-1">
                            {secondarynavigation.map((item) => (
                              <li key={item.name}>
                                {item.onClick ? (
                                  <button
                                    className="w-full group  flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-gray-700 hover:bg-gray-50 hover:text-primary"
                  ...
                  <ul role="list" className="-mx-2 mt-2 space-y-1">
                    {secondarynavigation.map((item) => (
                      <li key={item.name}>
                        {item.onClick ? (
                          <button
                            className="w-full group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-gray-700 hover:bg-secondary hover:text-primary"
                            onClick={() => item.onClick()}
                          >
                            <item.icon
                              className={classNames(
        ...
        <div className="lg:pl-72">
          ...
          >
            ...
            <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
              ...
              <div className="relative flex flex-1">{topMenu}</div>
